...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Completedate</label><p className="m-0 ml-3" ><Calendar id="completedate" value={new Date(_entity?.completedate)} disabled={true} hourFormat="24"  /></p></div>
