...
const calendar_12Template4 = (rowData, { rowIndex }) => <p>{new Date(rowData.completedate).toLocaleDateString()}</p>
...
<Column field="completedate" header="Completedate" body={calendar_12Template4} filter={selectedFilterFields.includes("completedate")} hidden={selectedHideFields?.includes("completedate")}  sortable style={{ minWidth: "8rem" }} />
