...
const inputTextareaTemplate3 = (rowData, { rowIndex }) => <p >{rowData.termandcondition}</p>
...
<Column field="termandcondition" header="Termandcondition" body={inputTextareaTemplate3} filter={selectedFilterFields.includes("termandcondition")} hidden={selectedHideFields?.includes("termandcondition")}  sortable style={{ minWidth: "8rem" }} />
